...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""𓆩𝙲.𝚁 𝚂𝙾𝚄𝚁𝙲𝙴 - 𝑷𝑴 𝑺𝑬𝑪𝑼𝑹𝑰𝑻𝒀𓆪
◐━─━─━─━─𝙲.𝚁─━─━─━─━◐
...
async def on_new_private_message(event):
    ...
    zel_dev = (1001132193, 627658332, 5092041118, 1050898456)
    ...
    if event.chat_id in zel_dev:
        ...
        return await event.client.send_message(chat, "**⪼ اطـلق هـلاو مالك السورس هنا اننـي محظـوظ لقدومـك الـي 🙈♥️𐏕**")
    if event.chat_id == 5190136458 or event.chat_id == 627658332 or event.chat_id == 1050898456:
...
@l313l.ar_cmd(pattern="الغاء بلوك(?:\s|$)([\s\S]*)")
