...
async def fetch_info(replied_user, event):
    ...
    rotbat = ".「  مآلُِڪ آلُِسورس 𓄂𓆃 」." if user_id == 1001132193 or user_id == 627658332 or user_id == 5092041118 or user_id == 5190136458 or user_id == 1833610203 else (".「  العضـو 𓅫 」.")
    rotbat = "⌁ مـالك الحساب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and user_id != 1001132193 and user_id != 627658332 and user_id != 5092041118 and user_id != 5190136458 and user_id != 1833610203  else rotbat
    caption = "✛┈┉━｢ ᥴ.𝘳 𝘴ꪮꪊ𝘳ᥴꫀ ｣━┅┈✛\n"
    ...
    caption += f"<b> {JEP_EM}❃  ⇜ {rotbat} </b>\n"
    caption += f"<b> {JEP_EM}❃آلصـور  ⇜ </b> {replied_user_profile_photos_count}\n"
    caption += f"<b> {JEP_EM}❃آلحسـآب  ⇜ </b> "
    caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
    caption += f"\n<b> {JEP_EM}❃آلبآيـﮯو  ⇜ </b> {user_bio} \n"
