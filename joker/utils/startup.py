    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await l313l.tgbot.send_file(
                ...
                buttons=[(Button.url("الهقر زين", "https://t.me/iiqllll"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await l313l.send_message("@BotFather", "cr")
            await asyncio.sleep(3)
            await l313l.send_message("@BotFather", "/setname")
            await asyncio.sleep(1)
            await l313l.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await l313l.send_message("@BotFather", f"مسـاعـد - {bot.me.first_name} ")
            await asyncio.sleep(3)
            await l313l.send_message("@BotFather", "/setuserpic")
            await asyncio.sleep(1)
            await l313l.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await l313l.send_file("@BotFather", "l313l/razan/resources/start/CR.JPEG")
            await asyncio.sleep(3)
            await l313l.send_message("@BotFather", "/setabouttext")
            await asyncio.sleep(1)
            await l313l.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await l313l.send_message("@BotFather", f"- بـوت كرستين المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
            await l313l.send_message("@BotFather", "/setdescription")
            await asyncio.sleep(1)
            await l313l.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await l313l.send_message("@BotFather", f"•⎆┊انـا البــوت المساعد  \n•⎆┊بـواسطـتـي يمكـنك التواصــل مـع مـالكـي 🧸♥️\n•⎆┊قنـاة السـورس 🌐 @S_EG_P 🌐")
        except Exception as e:
            print(e)
