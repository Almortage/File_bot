    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await jepiq.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph//file/835b48f330763bffc34a7.jpg",
                caption="**᯽︙ بــوت كرستين يـعـمـل بـنـجـاح ✓ **\n**᯽︙ ارسل `.الاوامر` لرؤية اوامر السورس**",
                buttons=[(Button.url("سورس كرستين", "https://t.me/S_EG_P"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", "/setcommands")
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", onbot)
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", "/setname")
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", name)
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", "/setdescription")
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", description)
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", "/setuserpic")
            await asyncio.sleep(1)
            await jepiq.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await jepiq.send_file(
                "@BotFather", "JepIQ/razan/resources/start/CR.JPEG"
            )
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "مجموعة أشعارات كرستين", jepiq, Config.TG_BOT_USERNAME, descript, photobt
        )
